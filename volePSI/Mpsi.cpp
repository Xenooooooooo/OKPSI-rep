...
namespace volePSI
{
    ...
    void Mpsi_User::run(u64 User_Num, u64 My_Id, u64 Set_Size, u64 Lambda, u64 Thread_Num, block Seed, std::vector<block> Inputs){
        ...
        if (My_Id == User_Num - 1){
            ...
            //User.setTimePoint("Share Finish");
            ...
            //User.setTimePoint("2-PSI Finish");
            ...
            //User.setTimePoint("Get Intersection Finish");
